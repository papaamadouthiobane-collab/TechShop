...
<body class="bg-gray-50">
            ...
            <div class="flex justify-between items-center">
                ...
                <div class="desktop-only flex items-center gap-6">
                    ...
                    <?php if(isset($_SESSION['user_id']) && $_SESSION['role'] == 'admin'): ?>
                        <!-- ======================================== -->
                        <!-- ADMIN CONNECTÉ : SEUL Dashboard + Admin Tech -->
                        <!-- ======================================== -->
                        ...
                        <div class="relative group">
                            <button class="flex items-center gap-2 text-gray-200 hover:text-blue-200 transition">
                                ...
                                <span><?php echo $_SESSION['nom'] ?? 'Admin'; ?></span>
                                <i class="fas fa-chevron-down text-xs"></i>
                            </button>
                            <div class="absolute right-0 mt-3 w-48 bg-white rounded-xl shadow-2xl dropdown-menu border border-gray-100">
                                <a href="/techshop/public/admin/index.php" class="block px-4 py-3 text-emerald-600 hover:bg-gray-50 rounded-t-xl"><i class="fas fa-user-shield mr-2"></i> Dashboard</a>
                                <a href="/techshop/public/profil.php" class="block px-4 py-3 text-gray-700 hover:bg-gray-50"><i class="fas fa-user mr-2"></i> Mon profil</a>
                    ...
                    <?php else: ?>
                        <!-- ======================================== -->
                        <!-- CLIENT CONNECTÉ OU NON CONNECTÉ       -->
                        <!-- ======================================== -->
    ...
    <div class="mobile-menu" id="mobileMenu">
        ...
        <div class="flex flex-col gap-4">
            ...
            <?php if(isset($_SESSION['user_id']) && $_SESSION['role'] == 'admin'): ?>
                <!-- ADMIN CONNECTÉ (mobile) : SEUL Dashboard + Admin Tech -->
